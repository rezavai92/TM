	...
	constructor(
		...
		router.events.subscribe(event => {
			if (event instanceof NavigationEnd) {
				...
				this.hideToolBar = currentApp && currentApp.data ? currentApp.data["hideToolBar"] : true;
				this.hideSideNavigation = currentApp && currentApp.data ? currentApp.data["hideSideNavigation"] : true;
			}
