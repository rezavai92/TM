...
export class MfsInfo implements IBankInformation<IMobileFinancialServiceInfo> {
	constructor(
		public Info: IMobileFinancialServiceInfo,
		public Type: string
	) {}
}
...
export class UserFinancialInfo {
	...
	public MobileFinancialServiceInfo: IMobileFinancialServiceInfo | null =
		null;
	...
	constructor(
		...
		if (bfs) {
			this.BankFinancialServiceInfo = {
				...
				AccountNumber: bfs.Info
					? parseInt(bfs.Info.AccountNumber.toString())
					: 0,
